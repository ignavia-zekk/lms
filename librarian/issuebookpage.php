...
<tr>
  <td>
    <input type="text" class="form-control" placeholder="Book Code" name="code">
  </td>
</tr>
<tr>
  <td>
...
{
  mysqli_query($link, "insert into issue_books values(' ' , '$_SESSION[senrollment]' , '$_POST[sname]' ,'$_POST[deptyr]','$_POST[utype]',  '$_POST[scontact]' , '$_POST[semail]' , '$_POST[bname]', '$_POST[bissuedate]' ,' ' , '$_SESSION[suname]','$_POST[code]','$_POST[isstime]',' ','$_POST[trgtdt]','$_POST[trgttm]') ");
mysqli_query($link, "update add_books set available_qty=available_qty-1 where book_title='$_POST[bname]' ");
mysqli_query($link, "update student_registration set brbooks=brbooks+1 where enrollment='$_SESSION[senrollment]' ");
?>
<script type="text/javascript">
